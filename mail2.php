...
$sendto   = "sales@dg-tech.kz"; // почта, на которую будет приходить письмо
...
$usermail = 'Письмо без  e-mail'; // сохраняем в переменную данные полученные из поля c адресом электронной почты
